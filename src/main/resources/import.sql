...
insert into member(userid, email, name, nickname, password, created_date, modified_date, role) values ("adminaccount", "admin@gmail.com", "admin", "manager", "$2a$10$fXHD8jxO.eTBvduwZlTzx.J3fAEPUjlSx5eUOT4JYUS7700dFYY.K", 20230518091726, 20230518091726, "ADMIN");
insert into member(userid, email, name, nickname, password, created_date, modified_date, role) values ("useraccount", "user@gmail.com", "user", "student", "$2a$10$fXHD8jxO.eTBvduwZlTzx.J3fAEPUjlSx5eUOT4JYUS7700dFYY.K", 20230518091726, 20230518091726, "USER");
